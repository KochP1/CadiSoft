...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM inscripcion WHERE idusuarios = p_idusuarios AND fecha_inscripcion = p_fecha_inscripcion AND fecha_expiracion = p_fecha_expiracion AND es_activa = 1) THEN
